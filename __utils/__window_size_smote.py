...
BASE = "./models/label/extra/smote/source"
TARGET = f"{BASE}/dataset_smote.csv"
DEST = f"{BASE}/{WINDOW_SIZE}/dataset.csv"
EXPANDED_COLS = [
    "cpu_usage",
    "memory_usage",
    "bandwidth_inbound",
...
if MODE == 1:
    DEST = f"{BASE}/{WINDOW_SIZE}_normalize/dataset.csv"
elif MODE == 2:
    DEST = f"{BASE}/{WINDOW_SIZE}_normalize_std/dataset.csv"
elif MODE == 3:
    DEST = f"{BASE}/{WINDOW_SIZE}_combine_0_1/dataset.csv"
